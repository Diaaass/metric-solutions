  ...
  const posts = [
    {
      ...
      excerpt:
        'Как искусственный интеллект и анализ больших данных меняют подход к геометаллургическому моделированию месторождений...',
      date: '15 марта 2024',
      category: 'Технологии',
    ...
    },
    {
      ...
      excerpt:
        'Разбор реальных примеров повышения точности учета металлов на обогатительных фабриках и выявления скрытых потерь...',
    ...
    },
    {
      ...
      excerpt:
        'Как детальное изучение минералогического состава руды позволяет подобрать оптимальные реагентные режимы и повысить извлечение...',
        ...
        <Container>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {posts.map((post, i) => (
              ...
              >
                ...
                <p className="text-secondary-600 mb-6 flex-grow line-clamp-3">{post.excerpt}</p>
          ...
          <div className="mt-16 text-center animate-fade-in delay-400">
            ...
            <p className="text-secondary-400 text-sm">
              Подпишитесь на нашу рассылку, чтобы не пропустить обновления
            </p>
          </div>
        </Container>
      </section>
